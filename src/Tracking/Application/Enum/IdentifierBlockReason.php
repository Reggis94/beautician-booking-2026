...
enum IdentifierBlockReason: string
{
    ...
    case LongRateLimit = 'tracking_visit_cookie.400_requests_per_24_hours';
    ...
    public function description(): string
    {
        return match ($this) {
            ...
            self::LongRateLimit => '400 requests are allowed per 24 hours; exceeding this blocks for 24 hours',
